...
\underline{$\theta$序列},
如果$\forall x\in X$, $ \exists m < \omega$ 使得$\mathscr{E}_m$在点$x$是点有限的.
...
($\Leftarrow$) 设$\mathscr{U} = \{ U_\alpha: \alpha\in\Delta\}$是$X$的开覆盖,且有可数闭覆盖
$\{F_n:n<\omega\}$.它有命题所说的性质,即$\mathscr{U}|_{F_n}$在子空间$F_n$上有点有限的开加细
$\mathscr{V}_n$.不妨设$\mathscr{V}_n=\{V_{n,\alpha}:\alpha\in\Delta\}$使得
$V_{n,\alpha}\subset U_\alpha\cap F_n$.取$X$的开集$V_{n,\alpha}^\prime$使得
$V_{n,\alpha}^\prime=V_{n,\alpha}\cap F_n$.$\forall n<\omega$, 令
...
\textnormal{(ii)} $\mathscr{G}^* =\{\cup \mathscr{G}_n: n<\omega\}$是$X$的点有限开覆盖.
...
据[Smith80]说, Chabber 研究了具有$\sigma$相对局部有限结构的空间.
