...
拓扑空间简称为空间.不附加任何分离公理.正规、正则空间也不必是$T_1$的.设$x\in X$, 记
\begin{center}
...
称$\mathscr{V}$加细$\mathscr{D}$,如果$\forall\beta\in\Gamma, \exists \delta(\beta)\in\Delta, V_\beta\subset D_{\delta(\beta)}$.
